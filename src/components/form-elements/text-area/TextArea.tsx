...
export interface TextAreaProps {
    ...
    placeholder?: string;
    /** Validation function that returns an error object (`code`, optional `message`) or a falsy value when valid */
    validation?: (value: string) => (TextAreaError & { code: string }) | null | undefined;
